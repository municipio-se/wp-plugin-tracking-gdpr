...
Filters the cookie category definitions used by the consent dialog and service settings.
...
Filters the replacement HTML used when content iframes are converted to consent-aware placeholders.
